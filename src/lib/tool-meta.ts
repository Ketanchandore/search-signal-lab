...
export const TOOL_META: Record<string, ToolMeta> = {
  ...
  "robots-checker": { slug: "robots-checker", name: "Robots.txt Checker", type: "Robots.txt Validator", title: "Robots.txt Checker — Validates AI Crawler Rules (GPTBot, ClaudeBot) | SEOAcademys", description: "Validate robots.txt syntax & check AI crawler directives (GPTBot, PerplexityBot, ClaudeBot). Free, no signup.", features: ["Robots.txt syntax parser", "AI-crawler directive audit", "Per-bot allow/disallow matrix", "Sitemap discovery"], faqs: buildFaqs("the Robots.txt Checker", "every User-agent rule including GPTBot, PerplexityBot and ClaudeBot", "monthly", "AI-crawler-specific directive audit") },
  "sitemap-checker": { slug: "sitemap-checker", name: "Sitemap Checker", type: "XML Sitemap Analyzer", title: "Sitemap Checker — Free XML Sitemap & Sitemap-Index Analyzer | SEOAcademys", description: "Parse sitemap.xml and sitemap-index files. Validates URL coverage, lastmod & priority. Free, no signup.", features: ["URL count & coverage", "Sitemap-index expansion", "lastmod / priority audit", "Broken URL flag"], faqs: buildFaqs("the Sitemap Checker", "every URL, lastmod and priority value in sitemap.xml", "monthly", "sitemap-index expansion and per-URL diagnostics") },
  ...
  "broken-links": { slug: "broken-links", name: "Broken Link Checker", type: "Broken Link Crawler", title: "Broken Link Checker — Free Live HEAD-Check Crawler | SEOAcademys", description: "Find every broken link on a page in real time with live HEAD requests. Free, no signup.", features: ["Real HEAD requests, not regex", "Status code per link", "Internal & external coverage", "Exportable CSV"], faqs: buildFaqs("the Broken Link Checker", "every outbound link with real HEAD-request status codes", "monthly", "real network HEAD-checks instead of regex parsing") },
  ...
  "schema-validator": { slug: "schema-validator", name: "Schema.org Validator", type: "JSON-LD Validator", title: "Schema Validator — Free JSON-LD Schema.org Validator | SEOAcademys", description: "Find every JSON-LD block, parse it & validate required properties. Free, no signup.", features: ["All JSON-LD blocks extracted", "Required-property validation", "Per-type rule set", "Inline JSON pretty-print"], faqs: buildFaqs("the Schema Validator", "every JSON-LD block and required-property check by @type", "before every publish", "per-type required-property enforcement") },
  ...
  "keyword-research": { slug: "keyword-research", name: "Keyword Research", type: "Keyword Ideas Tool", title: "Keyword Research — Free Long-Tail Ideas with Volume & KD | SEOAcademys", description: "Free keyword research with long-tail ideas, intent, volume & difficulty estimates. Free, no signup.", features: ["Long-tail expansion", "Intent classification", "Heuristic volume", "Difficulty estimate", "CPC estimate", "CSV export"], faqs: buildFaqs("the Keyword Research tool", "long-tail keyword ideas with intent, volume, KD and CPC estimates", "for every new topic cluster", "intent classification per keyword") },
